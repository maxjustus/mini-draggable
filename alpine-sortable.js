...
export default function AlpineSortable(Alpine) {
  Alpine.directive(
    ...
    (
      ...
      /** @param {number} i */
      const spliceOut = (i) => (expression ? evaluate(expression).splice(i, 1)[0] : undefined);
      /**
       * @param {number} i
       * @param {any} item
       */
